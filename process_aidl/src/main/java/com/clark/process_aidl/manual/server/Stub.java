...
import com.clark.process_aidl.manual.proxy.Proxy;

import java.util.List;

public abstract class Stub extends Binder implements ManualBookManager {
    ...
    public static ManualBookManager asInterface(IBinder binder) {
        if (binder == null)
            return null;
        IInterface iin = binder.queryLocalInterface(DESCRIPTOR);
        if (iin != null && iin instanceof ManualBookManager)
            return (ManualBookManager) iin;
