...
public class DownloadProgressButton extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mDefColor = typedArray.getColor(R.styleable.DownloadProgressButton_defColor, Color.parseColor("#9E9E9E"));
        mRectColor = typedArray.getColor(R.styleable.DownloadProgressButton_rectColor, Color.parseColor("#9E9E9E"));
        mProgressColor = typedArray.getColor(R.styleable.DownloadProgressButton_progressColor, Color.parseColor("#FF34A350"));
        mTabColor = typedArray.getColor(R.styleable.DownloadProgressButton_tabColor, Color.parseColor("#FF34A350"));
        mFontColor = typedArray.getColor(R.styleable.DownloadProgressButton_fontColor, Color.parseColor("#FF34A350"));


        mStrokeWidthCircle = typedArray.getDimension(R.styleable.DownloadProgressButton_progressWidth, 12);
        mRectWidth = typedArray.getDimension(R.styleable.DownloadProgressButton_rectWidth, 6);

        mTipsStr = typedArray.getString(R.styleable.DownloadProgressButton_tipsStr);
        if (TextUtils.isEmpty(mTipsStr)) {
            mTipsStr = "下载";
        }
/*        mTipsInstallStr = typedArray.getString(R.styleable.DownloadProgressButton_finishStr);
        if (TextUtils.isEmpty(mTipsInstallStr)) {
            mTipsInstallStr = "安装";
        }*/
        mTipsStrFontSize = typedArray.getDimension(R.styleable.DownloadProgressButton_fontSize, 40);
        typedArray.recycle();
