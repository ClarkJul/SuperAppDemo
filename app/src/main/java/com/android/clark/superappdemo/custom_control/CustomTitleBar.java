...
public class CustomTitleBar extends RelativeLayout {
    ...
    public CustomTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.custom_control_title_bar, this, true);
        ...
        //使用TypedArray来接受xml中的定义的属性值，与attrs定义的属性对应
        ...
        if (attributes != null) {
            ...
            if (!TextUtils.isEmpty(leftButtonText)) {
                ...
                int leftButtonDrawable = attributes.getResourceId(R.styleable.CustomTitleBar_left_button_drawable, R.mipmap.back_blue);
